...
using Avalon.Admin.ExceptionHandling;
using Avalon.Admin.Configuration;
using Avalon.Admin.Configuration.ApplicationParts;
using Avalon.Admin.Configuration.Constants;
using Avalon.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories.Interfaces;
using Avalon.Admin.Helpers.Localization;
using System.Linq;
using Avalon.Admin.EntityFramework.MySql.Extensions;
using Avalon.Admin.EntityFramework.Shared.Configuration;
using Avalon.Admin.EntityFramework.SqlServer.Extensions;
using Avalon.Admin.EntityFramework.PostgreSQL.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using Avalon.Shared.Authentication;

namespace Avalon.Admin.Helpers
{
