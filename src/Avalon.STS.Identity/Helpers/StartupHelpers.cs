...
using SendGrid;
using Avalon.Shared.Configuration.Email;
using Avalon.Shared.Email;
using Avalon.STS.Identity.Configuration;
using Avalon.STS.Identity.Configuration.ApplicationParts;
using Avalon.STS.Identity.Configuration.Constants;
using Avalon.STS.Identity.Configuration.Interfaces;
using Avalon.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace Avalon.STS.Identity.Helpers
{
